...
app.get('*', function (req, res, next) {
  (0, _api.fetchAllTasks)().then(function (data) {
    var markup = (0, _server.renderToString)(_react2.default.createElement(_App2.default, { data: data.data }));

    res.send("\n    <!DOCTYPE html>\n    <html>\n      <head>\n        <title>SSR with RR</title>\n        <script src=\"/bundle.js\" defer></script>\n        <script>window.__INITIAL_DATA__ = " + (0, _serializeJavascript2.default)(data.data) + "</script>\n      </head>\n\n      <body>\n        <div id=\"app\">" + markup + "</div>\n      </body>\n    </html>\n  ");
  });
});
...
function fetchAllTasks() {
  var encodedURI = encodeURI('http://127.0.0.1:4000/');
